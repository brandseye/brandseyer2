...
#' like to know more, see the documentation for [authenticate()].
#'
#' After this, you can easily see a list of your available accounts using
#' [list_account_codes()]. [account_count()] will
#' let you pull aggregate information matching a given filter from one or more
#' of your accounts.
#'
#' @seealso [list_account_codes()] Find out what accounts you have access to.
#' @seealso [account_count()] Query your account.
#' @seealso [account()] Find out about general account queries.
#' 
#' @docType package
#' @name brandseyer2
