...
account("QUIR01BA", "BEUB03AA") %>% 
  filter_mentions("published inthelast week and relevancy isnt irrelevant") %>% 
  compare_mentions(africa = "location is 'ZA'", elsewhere = "location isnt 'ZA'") %>% 
  count_mentions()
#> # A tibble: 4 x 3
#>   account  comparison mentionCount
#>   <chr>    <chr>             <int>
#> 1 QUIR01BA africa              101
#> 2 QUIR01BA elsewhere          7865
#> 3 BEUB03AA africa             8226
#> 4 BEUB03AA elsewhere           252
```
